...
!!! info
    This example can be found in the [examples/Linear_PB_solver][6] directory in the repository folder. If you didn't 
...
!!! note
  ...
  [6]: https://github.com/Valdes-Tresanco-MS/gmx_MMPBSA/tree/master/examples/Linear_PB_solver
