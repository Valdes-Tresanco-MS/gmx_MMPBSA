...
In this case, Li/Merz ion parameters (12-6 normal usage set) for Zn ions were used. Check [Amber manual][1] for more 
...
"Export GB/PB energy (csv)".
  ...
  [1]: https://ambermd.org/doc12/Amber20.pdf#section.3.6