...
!!! info
    This example can be found in the [docs/examples/Protein_ligand/ST][6] directory in the repository folder
...
=== "With MPI"
        ...
        mpirun -np 2 gmx_MMPBSA -O -i mmpbsa.in -cs com.tpr -ci index.ndx -cg 1 13 -ct com_traj.xtc -lm ligand.mol2
...
!!! note
  ...
  [6]: https://github.com/Valdes-Tresanco-MS/gmx_MMPBSA/tree/master/docs/examples/Protein_ligand/ST
