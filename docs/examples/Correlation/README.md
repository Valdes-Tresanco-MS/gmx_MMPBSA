...
The values above are the experimental inhibition constants bundled with this example. `exp_ki` is expressed in nM
and is used by the analyzer to derive the experimental binding energy for the correlation.
