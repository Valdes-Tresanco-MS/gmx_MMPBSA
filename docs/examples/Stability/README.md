...
!!! info
    This example can be found in the [examples/Stability/][6] directory in the repository folder. If you didn't 
...
=== "Serial"
        ...
        gmx_MMPBSA -O -i mmpbsa.in -s -cs com.tpr -ci index.ndx -cg 19 20 -ct com_traj.xtc -o FINAL_RESULTS_MMPBSA.dat -eo FINAL_RESULTS_MMPBSA.csv
...
!!! note
  ...
  [6]: https://github.com/Valdes-Tresanco-MS/gmx_MMPBSA/tree/master/examples/Stability
