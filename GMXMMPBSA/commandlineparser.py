...
group.add_argument('-ls', dest='ligand_tpr', metavar='<Structure File>', default=None,
                   help='''Structure file of the unbound ligand. If omitted, is protein-like and stability is False, 
                   the structure from complex will be used.''')
group.add_argument('-li', dest='ligand_index', metavar='<Index File>',
                   default=None, help='Index file of the unbound ligand.')
group.add_argument('-lg', dest='ligand_group', metavar='index', default=None,
                   help='Group of the ligand in ligand index file.')
