    ...
    def __init__(self, INPUT):
        ...
        for key in list(self.input_items.keys()):
            ...
            try:
                ...
                # print(key in self.parent_namelist, key, key in INPUT[self.name_map])
                print(key)
...
class SanderRISMInput(SanderInput):
    ...
    input_items = {'ntb': 0, 'cut': 999.0, 'nsnb': 99999, 'idecomp': 0, 'offset': -999999.0,
                   ...
                   # Basic options
                   'closure': "kh", 'thermo': "std", 'noasympcorr': 1, 'buffer': 14.0, 'solvcut': -1.0,
                   'grdspc': 0.5, 'ng': '-1,-1,-1', 'solvbox': '-1,-1,-1', 'tolerance': 1e-05, 'ljtolerance': -1.0,
                   ...
                   'mdiis_del': 0.7, 'mdiis_nvec': 5, 'mdiis_restart': 10.0, 'maxstep': 10000, 'npropagate': 5,
                   'polardecomp': 0, 'rism_verbose': 0}

    parent_namelist = {'ntb': 'cntrl', 'cut': 'cntrl', 'nsnb': 'cntrl', 'idecomp': 'cntrl', 'offset': 'cntrl',
                       'imin': 'cntrl', 'maxcyc': 'cntrl', 'ncyc': 'cntrl', 'gbsa': 'cntrl', 'ioutfm': 'cntrl',
                       'dec_verbose': 'cntrl', 'irism': 'cntrl',
                       # Basic options
                       'closure': 'rism', 'thermo': 'rism', 'noasympcorr': 'rism', 'buffer': 'rism', 'solvcut': 'rism',
                       'grdspc': 'rism', 'ng': 'rism', 'solvbox': 'rism', 'tolerance': 'rism', 'ljtolerance': 'rism',
                       'asympkspacetolerance': 'rism', 'treedcf': 'rism', 'treetcf': 'rism', 'treecoulomb': 'rism',
                       ...
                       'treecoulombn0': 'rism', 'mdiis_del': 'rism', 'mdiis_nvec': 'rism', 'mdiis_restart': 'rism',
                       'maxstep': 'rism', 'npropagate': 'rism', 'polardecomp': 'rism', 'rism_verbose': 'rism'}

    name_map = {'ntb': 'ntb', 'cut': 'cut', 'nsnb': 'nsnb', 'idecomp': 'idecomp', 'offset': 'offset',
                'imin': 'imin', 'gbsa': 'gbsa', 'ioutfm': 'netcdf', 'dec_verbose': 'dec_verbose',
                'maxcyc': 'rism_maxcyc', 'ncyc': 'ncyc',
                # Basic options
                'closure': 'closure', 'thermo': 'thermo', 'noasympcorr': 'noasympcorr', 'buffer': 'buffer',
                'solvcut': 'solvcut', 'grdspc': 'grdspc', 'ng': 'ng', 'solvbox': 'solvbox', 'tolerance': 'tolerance',
                'ljtolerance': 'ljtolerance', 'asympkspacetolerance': 'asympkspacetolerance', 'treedcf': 'treedcf',
                ...
                'treetcfn0': 'treetcfn0', 'treecoulombn0': 'treecoulombn0', 'mdiis_del': 'mdiis_del',
                'mdiis_nvec': 'mdiis_nvec', 'mdiis_restart': 'mdiis_restart', 'maxstep': 'maxstep',
                'npropagate': 'npropagate', 'polardecomp': 'polardecomp', 'rism_verbose': 'rism_verbose'}
