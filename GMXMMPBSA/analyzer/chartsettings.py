    ...
    default = {
        ...
        'children': {
            'General': {
                ...
                'children': {
                    'theme': {
                        'type': 'list', 'enabled': True, 'expanded': True, 'name': 'theme', 'value': 'whitegrid',
                        'values': ['whitegrid', '---0', 'ticks', 'darkgrid', 'dark', 'white'],
                        'default': 'whitegrid',
            ...
            'Line Plot': {
                ...
                'children': {
                    'line-width': {'type': 'float', 'enabled': True, 'expanded': True, 'name': 'line-width',
                                   'value': 0.9, 'step': 0.1, 'limits': (0.1, 1.5), 'accelerated': True,
                                   'default': 0.9, 'action_type': R},
                    ...
                    'Rolling average': {
                        ...
                        'children': {
                            ...
                            'width': {'type': 'float', 'enabled': True, 'expanded': True, 'name': 'width',
                                      'value': 1.0, 'step': 0.1, 'default': 1.0, 'action_type': R},
                    ...
                    'fontsize': {
                        ...
                        'children': {
                            ...
                            'x-label': {'type': 'int', 'enabled': True, 'expanded': True, 'name': 'x-label',
                                        'value': 13, 'default': 13, 'action_type': D},
            ...
            'Bar Plot': {
                ...
                'children': {
                    ...
                    'palette': {'type': 'list', 'enabled': True, 'expanded': True, 'name': 'palette',
                                'value': 'colorblind',
                                'values': ['colorblind', '---0', 'deep', 'muted', 'bright', 'pastel', 'dark',
                                                            'husl', 'hls', '---1',
                                                            'Pastel1', 'Pastel2', 'Paired', 'Accent', 'Dark2', 'Set1',
                                                            'Set2', 'Set3', 'tab10', 'tab20', 'tab20b', 'tab20c'],
                                'default': 'colorblind', 'action_type': R, 'tip': tooltip2},
                    'color': {'type': 'color', 'enabled': True, 'expanded': True, 'name': 'color',
                    ...
                    'error-line': {'type': 'group', 'enabled': True, 'expanded': True, 'name': 'error-line',
                                   ...
                                   'children': {
                                       'width': {'type': 'float', 'enabled': True, 'expanded': True, 'name': 'width',
                                                 'value': 0.8, 'step': 0.1, 'limits': (0.1, 1.5),
                                                 'accelerated': True, 'default': 0.8, 'action_type': R},
    ...
    default = {
        ...
        'children': {
            ...
            'Regression Plot': {
                ...
                'children': {
                    'line-width': {'type': 'float', 'enabled': True, 'expanded': True, 'name': 'line-width',
                                   'value': 1.1, 'step': 0.1, 'limits': (0.1, 1.5), 'accelerated': True,
                                   'default': 1.1, 'action_type': R},
                    'line-color': {'type': 'color', 'enabled': True, 'expanded': True, 'name': 'line-color',
                                   'value': [0, 0, 0, 255], 'default': [0, 0, 0, 255], 'action_type': R},
                    ...
                    'Scatter': {
                        ...
                        'children': {
                            ...
                            'alpha': {'type': 'float', 'enabled': True, 'expanded': True, 'name': 'alpha',
                                      'value': 0.35, 'step': 0.01, 'default': 0.35, 'limits': (0, 1), 'action_type': R},
                            'marker-size': {'type': 'int', 'enabled': True, 'expanded': True, 'name': 'marker-size',
                                            'value': 18, 'step': 1, 'default': 18, 'limits': (2, 100),
