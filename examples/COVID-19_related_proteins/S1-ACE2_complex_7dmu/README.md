...
!!! info
    This example can be found in the [examples/COVID-19_related_proteins/S1-ACE2_complex_7dmu][6] directory in the
...
index file (`20 19`) are needed. The `mmpbsa.in` input file contains all the parameters needed for the MM/PB(GB)SA
...
!!! note
  ...
  [6]: https://github.com/Valdes-Tresanco-MS/gmx_MMPBSA/tree/master/examples/COVID-19_related_proteins/S1-ACE2_complex_7dmu
