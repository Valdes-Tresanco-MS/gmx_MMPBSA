---
template: main.html
title: SARS-CoV-2 Main Protease in complex with demethylated analog of masitinib
---
...
!!! info
    This example can be found in the [examples/COVID-19_related_proteins/Main_protease_7l5d][6] directory in the
...
index file (`1 13`) are needed. The `mmpbsa.in` input file contains all the parameters needed for the MM/PB(GB)SA
...
!!! note
  ...
  [2]: ../../../docs/gmx_MMPBSA_command-line.md#gmx_mmpbsa-command-line
  [3]: ../../../docs/input_file.md#the-input-file
  [4]: ../../../docs/input_file.md#sample-input-files
  [5]: ../../../docs/analyzer.md#gmx_mmpbsa_ana-the-analyzer-tool
  [6]: https://github.com/Valdes-Tresanco-MS/gmx_MMPBSA/tree/master/examples/COVID-19_related_proteins/Main_protease_7l5d
