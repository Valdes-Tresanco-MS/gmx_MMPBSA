...
setup(
    ...
    package_data={"GMXMMPBSA": ["data/*", 'data/gmxMMPBSA/*', 'analyzer/style/*', 'GMXMMPBSA.sh']},
    license='GPLv3',
    ...
    install_requires=['pandas>=1.2.2', 'seaborn>=0.11.1', 'mpi4py>=3.1.3', 'scipy>=1.6.1', 'matplotlib==3.4.3', 'h5py'],
    entry_points={
        "console_scripts": [
